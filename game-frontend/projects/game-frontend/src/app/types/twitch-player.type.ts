import { TwitchPlayerOptions } from './twitch-player-options.type';

/**
 *
 * @see https://github.com/frozencure/twitch-player
 * @since 0.9.1
 * @export
 */
export declare class Player {
    public static readonly OFFLINE;
    public static readonly ONLINE;
