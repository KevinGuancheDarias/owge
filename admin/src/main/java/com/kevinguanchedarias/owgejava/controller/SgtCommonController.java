...
import com.kevinguanchedarias.owgejava.business.WithNameBo;
import com.kevinguanchedarias.owgejava.entity.EntityWithImage;
...
public abstract class SgtCommonController<E extends SimpleIdEntity> extends CommonController {
	...
	/**
	 * Will save to database, handling db exceptions and known OWGE exceptions
	 * 
	 * @param withNameBo
