...
import com.kevinguanchedarias.owgejava.configurations.SqsConfiguration;
...
public class SqsManagerService {
    ...
    @PostConstruct
    public void init() {
        String host = sqsConfiguration.getHost();
        Integer port = sqsConfiguration.getPort();
        String queue = sqsConfiguration.getQueue();
