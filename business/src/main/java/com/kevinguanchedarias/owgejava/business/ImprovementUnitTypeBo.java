...
@Service
public class ImprovementUnitTypeBo implements Serializable, WithToDtoTrait<ImprovementUnitType, ImprovementUnitTypeDto> {
    ...
    @Override
    public Class<ImprovementUnitTypeDto> getDtoClass() {
        return ImprovementUnitTypeDto.class;
    }
    ...
    public boolean isSameTarget(ImprovementUnitTypeDto improvementUnitTypeDto,
        ...
        return improvementUnitTypeDto.getType().equals(improvementUnitTypeDto2.getType())
                && improvementUnitTypeDto.getUnitType().getId().equals(improvementUnitTypeDto2.getUnitType().getId());
    }
