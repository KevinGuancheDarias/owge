...
impl GalaxyBo {
    ...
    pub async fn find_all(conn: &mut MySqlConnection) -> OwgeResult<Vec<GalaxyDto>> {
    ...
    pub async fn find_by_id(conn: &mut MySqlConnection, id: u16) -> OwgeResult<Option<GalaxyDto>> {
    ...
    pub async fn has_players(conn: &mut MySqlConnection, id: u16) -> OwgeResult<bool> {
