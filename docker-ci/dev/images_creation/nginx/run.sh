...
envFailureCheck "OWGE_ADMIN_FRONTEND_SERVER" "$OWGE_ADMIN_FRONTEND_SERVER" The IP or hostname of the admin frontend server and the port
...
(
    docker run -d  -p 81:80 --rm \
        ...
        --env "OWGE_ADMIN_FRONTEND_SERVER=$OWGE_ADMIN_FRONTEND_SERVER" \
